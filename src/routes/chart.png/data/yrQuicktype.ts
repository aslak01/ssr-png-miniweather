...
const typeMap: any = {
  ...
  Units: o(
    [
      { json: 'air_pressure_at_sea_level', js: 'air_pressure_at_sea_level', typ: '' },
  ...
  Data: o(
    [
      ...
      { json: 'next_12_hours', js: 'next_12_hours', typ: u(undefined, r('Next12_Hours')) },
      { json: 'next_1_hours', js: 'next_1_hours', typ: u(undefined, r('NextHours')) },
      { json: 'next_6_hours', js: 'next_6_hours', typ: u(undefined, r('NextHours')) }
    ],
    false
  ),
  Instant: o([{ json: 'details', js: 'details', typ: r('InstantDetails') }], false),
  InstantDetails: o(
    [
      { json: 'air_pressure_at_sea_level', js: 'air_pressure_at_sea_level', typ: 3.14 },
