...
const createChart = (data: YrTSData[], dimensions: Dimensions, style: Styles): Canvas => {
  const ratio = dev ? 2 : 1;
...
const createChartBuffer = (data: YrTSData[], dimensions: Dimensions, style: Styles): Buffer => {
